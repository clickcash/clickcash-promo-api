                ...
                if (data.promos) {
                    if (data.promos.length > 0) {
                        ...
                        if (promoData.format == "image") {                           
                            ...
                            el.innerHTML = '<IFRAME ' + promoData.attributes + ' SRC="https://www.ifriends.net' + promoData.launchURL + '?t=' + promoData.t + promoData.queryArgs + '&' + urlSuffix + '" height="' + promoData.height + '" width="' + promoData.width + '"  scrolling="No" frameborder="0" align="top"></IFRAME>' + promoData.extracode;
